    ...
    def __init__(
        ...
        for _ in range(num_blocks):
            blocks.append(
                ...
                GhostBottleneck(
                    in_channels,                        # 192
                    int(out_channels * expand),         # 96*1
                    out_channels,                       # 96
                    dw_kernel_size=kernel_size,         # 5
...
class GhostPAN(nn.Module):
    ...
    def __init__(
        ...
        # 232 --> 96
        # 464 --> 96
        for idx in range(len(in_channels)):         # [116, 232, 464]   
            self.reduce_layers.append(
                ConvModule(
                    in_channels[idx],               # 116, 232 或 464
                    out_channels,                   # 96
                    1,
